...
```{r}
palest.df <- data.frame(nomes = c("Nathan", "Rafael"),
                        gosta_mat = c("Ciência Política", "Sociologia"),
                        conhe_r = c(9, 7),
                        notas_poli = c(9.12344123, 8.093827133),
                        notas_soc = c(8.1, 9.3))

palest.df
```

Podemos pedir a média de uma coluna. Para isso, utilizamos o *$* como nome da nossa coluna, após o nome do nosso *data frame*. Por exemplo, caso você queira a coluna com os nomes, basta escrever *palest.df$nomes*.
