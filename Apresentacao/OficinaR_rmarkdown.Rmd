...
```{r}
matriz_1 <- matrix(data = c(1,2,3,4), nrow = 2, ncol = 2, byrow = T) #Cria uma matriz 2x2 com os números 1,2,3,4
...
```{r}
palest.df <- data.frame(pales = c("Nathan", "Rafael"),
...
table(palest.df$gosta_mat)

table(palest.df$pales)
