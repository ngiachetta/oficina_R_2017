...
# 2. Primeiros passos - NÃO!!! Sobretudo a segunda parte dá para discutir na seção de booleanos, não tem necessidade desse inicio. (Sugestão: colocar essa parte na atribuição ao objetvo, como por exemplo x <- 5 + 1; z <- 6/3...)
